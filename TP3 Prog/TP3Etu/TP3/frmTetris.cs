...
namespace TP3
{
  ...
  {
    private frmParametres tailleJeu;
    ...
    const int nbLignesJeu = tailleJeu.trackBarLignes.Value;
    ...
    private void frmLoad( object sender, EventArgs e )
    {
      ...
      tailleJeu = new frmParametres();
      tailleJeu.ShowDialog();
      InitialiserSurfaceDeJeu(tailleJeu.trackBarLignes.Value, tailleJeu.trackBarColonnes.Value);
